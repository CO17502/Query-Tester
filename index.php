...
<html>
	...
	<body>
		...
		<form id="queryform" action="" method="POST">
			...
			<div id="pdo">
				<strong style="font-weight: normal;">PHP code for a PDO connection to this database:</strong>
				<aside>
...
$query = $_POST['query'];
	...
	echo "<table border='1' style='margin:20px; border-collapse: collapse;'><tr>";
